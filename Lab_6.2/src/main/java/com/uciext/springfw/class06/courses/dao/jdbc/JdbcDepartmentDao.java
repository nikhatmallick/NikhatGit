...
import com.uciext.springfw.class06.courses.dao.DepartmentDao;
...
public class JdbcDepartmentDao implements DepartmentDao {
	...
	public void updateDepartment(int departmentId, Department department) {
		logger.info("In updateDepartment: departmentId=" + departmentId + ", department=" + department);
		Connection conn = null;
	...
	public void deleteDepartment(int departmentId) {
		logger.info("In deleteDepartment departmentId=" + departmentId);
		Connection conn = null;
		...
		logger.info("exit deleteDepartment");
	}
